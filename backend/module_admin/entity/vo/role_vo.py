...
class RoleModel(BaseModel):
    ...
    @classmethod
    @field_validator('menu_check_strictly', 'dept_check_strictly')  # 自定义fields校验规则
    def check_filed_mapping(cls, v: Union[int, bool]) -> Union[int, bool]:  # v：待检验field的value值
        if v == 1:
            v = True
        elif v == 0:
            v = False
