...
DROP database if EXISTS `eaviz`;
CREATE database if NOT EXISTS `eaviz` default character set utf8mb4 collate utf8mb4_0900_ai_ci;
use `eaviz`;
...
values (100, 0, '0', '集团总公司', 0, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳分公司', 1, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (102, 100, '0,100', '长沙分公司', 2, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, 'xzzzz', '15888888888', 'xzzzz@qq.com', '0', '0', 'admin', sysdate(), '',
        null);
...
values (1, 103, 'admin', '超级管理员', '00', 'admin@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, 'xzzzz', '测试员', '00', 'xzzzz@qq.com', '15666666666', '1', '',
        '$2b$12$mteHL3XUpoIABIy0rJrOlOt7HNEppKnL17zaoHjQkXUNPVCzocX2q', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
insert into sys_role
values ('3', 'EAVizer', 'eaviz', 2, 2, 1, 1, '0', '0', 'admin', sysdate(), '', null, 'EAViz角色');
...
values ('4', '智能分析', '0', '4', 'eaviz', null, '', 1, 0, 'M', '0', '0', '', 'guide', 'admin', sysdate(), '', null,
        '智能分析目录');
insert into sys_menu
values ('5', '智慧助手', '0', '5', 'agent', 'agent/index', '', 1, 0, 'M', '0', '0', 'agent:use', 'example', 'admin',
        sysdate(), '', null, '智慧助手目录');
-- 二级菜单
insert into sys_menu
...
insert into sys_menu
values ('111', '定时任务', '2', '2', 'job', 'monitor/job/index', '', 1, 0, 'C', '0', '0', 'monitor:job:list', 'job',
        'admin', sysdate(), '', null, '定时任务菜单');
insert into sys_menu
values ('112', '数据监控', '2', '3', 'druid', 'monitor/druid/index', '', 1, 0, 'C', '0', '0', 'monitor:druid:list',
        'druid', 'admin', sysdate(), '', null, '数据监控菜单');
insert into sys_menu
values ('113', '服务监控', '2', '4', 'server', 'monitor/server/index', '', 1, 0, 'C', '0', '0', 'monitor:server:list',
        'server', 'admin', sysdate(), '', null, '服务监控菜单');
insert into sys_menu
values ('114', '缓存监控', '2', '5', 'cache', 'monitor/cache/index', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',
        'redis', 'admin', sysdate(), '', null, '缓存监控菜单');
insert into sys_menu
values ('115', '缓存列表', '2', '6', 'cacheList', 'monitor/cache/list', '', 1, 0, 'C', '0', '0', 'monitor:cache:list',
...
insert into sys_menu
values ('117', '代码生成', '3', '2', 'gen', 'tool/gen/index', '', 1, 0, 'C', '0', '0', 'tool:gen:list', 'code', 'admin',
        sysdate(), '', null, '代码生成菜单');
insert into sys_menu
values ('118', '系统接口', '3', '3', 'swagger', 'tool/swagger/index', '', 1, 0, 'C', '0', '0', 'tool:swagger:list',
        'swagger', 'admin', sysdate(), '', null, '系统接口菜单');
insert into sys_menu
values ('119', 'ESC+SD', '4', '1', 'escsd', 'eaviz/escsd/index', '', 1, 0, 'C', '0', '0', 'eaviz:escsd:use', 'skill',
        'admin', sysdate(), '', null, '癫痫综合征分类及发作检测菜单');
insert into sys_menu
values ('120', 'AD', '4', '2', 'ad', 'eaviz/ad/index', '', 1, 0, 'C', '0', '0', 'eaviz:ad:use', 'skill', 'admin',
        sysdate(), '', null, '伪迹检测菜单');
insert into sys_menu
values ('121', 'SpiD', '4', '3', 'spid', 'eaviz/spid/index', '', 1, 0, 'C', '0', '0', 'eaviz:spid:use', 'skill',
...
-- EDF管理按钮
insert into sys_menu
values ('1061', 'EDF查询', '109', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:edf:query', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1062', 'EDF导入', '109', '2', '#', '', '', 1, 0, 'F', '0', '0', 'system:edf:import', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1063', 'EDF删除', '109', '3', '#', '', '', 1, 0, 'F', '0', '0', 'system:edf:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
...
values ('1046', '在线查询', '110', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:query', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1047', '批量强退', '110', '2', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:batchLogout', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1048', '单条强退', '110', '3', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:forceLogout', '#', 'admin',
        sysdate(), '', null, '');
-- 定时任务按钮
insert into sys_menu
values ('1049', '任务查询', '111', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:query', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1050', '任务新增', '111', '2', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:add', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1051', '任务修改', '111', '3', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:edit', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1052', '任务删除', '111', '4', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1053', '状态修改', '111', '5', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:changeStatus', '#', 'admin',
        sysdate(), '', null, '');
insert into sys_menu
values ('1054', '任务导出', '111', '6', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:export', '#', 'admin', sysdate(),
        '', null, '');
-- 操作日志按钮
insert into sys_menu
...
-- 代码生成按钮
insert into sys_menu
values ('1055', '生成查询', '117', '1', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:query', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1056', '生成修改', '117', '2', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:edit', '#', 'admin', sysdate(), '',
        null, '');
insert into sys_menu
values ('1057', '生成删除', '117', '3', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:remove', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1058', '导入代码', '117', '4', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:import', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1059', '预览代码', '117', '5', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:preview', '#', 'admin', sysdate(),
        '', null, '');
insert into sys_menu
values ('1060', '生成代码', '117', '6', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:code', '#', 'admin', sysdate(), '',
        null, '');
-- ESCSD分析按钮
insert into sys_menu
values ('1065', 'ESCSD', '119', '1', '#', '', '', 1, 0, 'F', '0', '0', 'eaviz:escsd:analyse', '#', 'admin', sysdate(),
        '', null, '');
-- AD分析按钮
insert into sys_menu
values ('1066', 'AD', '120', '1', '#', '', '', 1, 0, 'F', '0', '0', 'eaviz:ad:analyse', '#', 'admin', sysdate(), '',
        null, '');
-- SpiD分析按钮
insert into sys_menu
values ('1067', 'SpiD', '121', '1', '#', '', '', 1, 0, 'F', '0', '0', 'eaviz:spid:analyse', '#', 'admin', sysdate(), '',
        null, '');
-- SRD分析按钮
insert into sys_menu
values ('1068', 'SRD', '122', '1', '#', '', '', 1, 0, 'F', '0', '0', 'eaviz:srd:analyse', '#', 'admin', sysdate(), '',
        null, '');
-- VD分析按钮
insert into sys_menu
values ('1069', 'VD', '123', '1', '#', '', '', 1, 0, 'F', '0', '0', 'eaviz:vd:analyse', '#', 'admin', sysdate(), '',
        null, '');
...
insert into sys_dict_type
values (6, '任务执行器', 'sys_job_executor', '0', 'admin', sysdate(), '', null, '任务执行器列表');
insert into sys_dict_type
values (7, '系统是否', 'sys_yes_no', '0', 'admin', sysdate(), '', null, '系统是否列表');
insert into sys_dict_type
values (8, '通知类型', 'sys_notice_type', '0', 'admin', sysdate(), '', null, '通知类型列表');
insert into sys_dict_type
values (9, '通知状态', 'sys_notice_status', '0', 'admin', sysdate(), '', null, '通知状态列表');
insert into sys_dict_type
values (10, '操作类型', 'sys_oper_type', '0', 'admin', sysdate(), '', null, '操作类型列表');
insert into sys_dict_type
values (11, '系统状态', 'sys_common_status', '0', 'admin', sysdate(), '', null, '登录状态列表');
...
insert into sys_dict_data
values (11, 2, '数据库', 'sqlalchemy', 'sys_job_group', '', '', 'N', '0', 'admin', sysdate(), '', null, '数据库分组');
insert into sys_dict_data
values (12, 3, 'redis', 'redis', 'sys_job_group', '', '', 'N', '0', 'admin', sysdate(), '', null, 'reids分组');
insert into sys_dict_data
values (13, 1, '默认', 'default', 'sys_job_executor', '', '', 'N', '0', 'admin', sysdate(), '', null, '线程池');
insert into sys_dict_data
values (14, 2, '进程池', 'processpool', 'sys_job_executor', '', '', 'N', '0', 'admin', sysdate(), '', null, '进程池');
insert into sys_dict_data
values (15, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 'Y', '0', 'admin', sysdate(), '', null, '系统默认是');
insert into sys_dict_data
values (16, 2, '否', 'N', 'sys_yes_no', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '系统默认否');
insert into sys_dict_data
values (17, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', sysdate(), '', null, '通知');
insert into sys_dict_data
values (18, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', sysdate(), '', null, '公告');
insert into sys_dict_data
values (19, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', sysdate(), '', null, '正常状态');
insert into sys_dict_data
values (20, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '关闭状态');
insert into sys_dict_data
values (21, 99, '其他', '0', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '其他操作');
insert into sys_dict_data
values (22, 1, '新增', '1', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '新增操作');
insert into sys_dict_data
values (23, 2, '修改', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', null, '修改操作');
insert into sys_dict_data
values (24, 3, '删除', '3', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '删除操作');
insert into sys_dict_data
values (25, 4, '授权', '4', 'sys_oper_type', '', 'primary', 'N', '0', 'admin', sysdate(), '', null, '授权操作');
insert into sys_dict_data
values (26, 5, '导出', '5', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '导出操作');
insert into sys_dict_data
values (27, 6, '导入', '6', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '导入操作');
insert into sys_dict_data
values (28, 7, '强退', '7', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '强退操作');
insert into sys_dict_data
values (29, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', null, '生成操作');
insert into sys_dict_data
values (30, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '清空操作');
insert into sys_dict_data
...
-- ----------------------------
insert into sys_job
values (1, '系统默认（无参）', 'default', 'default', 'module_task.scheduler_test.job', NULL, NULL, '0/10 * * * * ?', '3',
        '1', '1', 'admin', sysdate(), '', null, '');
insert into sys_job
values (2, '系统默认（有参）', 'default', 'default', 'module_task.scheduler_test.job', 'test', NULL, '0/15 * * * * ?',
...
values ('1', '温馨提醒：2018-07-01 vfadmin新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice
values ('2', '维护通知：2018-07-01 vfadmin系统凌晨维护', '1', '维护内容', '0', 'admin', sysdate(), '', null, '管理员');
...
-- 20、EDF表
-- ----------------------------
drop table if exists sys_edf;
create table sys_edf
(
    edf_id         int not null auto_increment comment 'EDF文件ID',
    edf_name       varchar(255) default '' comment 'EDF文件名',
    edf_sfreq      float        default 0.0 comment 'EDF采样频率',
    edf_time       float        default 0.0 comment 'EDF采样时长',
    edf_path       varchar(255) default '' comment 'EDF文件路径',
    valid_channels varchar(255) default '' comment '有效通道',
...
-- ----------------------------
-- 21、EDF和用户关联表  EDF N-1用户
-- ----------------------------
drop table if exists sys_edf_user;
create table sys_edf_user
(
    edf_id  int        not null comment 'EDF文件ID',
    user_id bigint(20) not null comment '用户ID',
    primary key (edf_id, user_id)
) engine = innodb
  DEFAULT CHARSET = utf8mb4
    comment = 'EDF和用户关联表';
